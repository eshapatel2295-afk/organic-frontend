...
const Home = () => {
  ...
  useEffect(() => {
    const fetchModules = async () => {
      try {
        const res = await fetch("https://organic-backend-r7th.onrender.com/api/learning-modules?limit=3");
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await fetch("https://organic-backend-r7th.onrender.com/api/products");
        const data = await res.json();
